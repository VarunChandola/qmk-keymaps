...
echo "=== QMK Iris Rev4 Build Script ==="
...
QMK_KEYMAP_DIR="$QMK_DIR/keyboards/keebio/iris/rev4/keymaps/varun"
...
echo "Building keebio/iris/rev4:varun${FLASH_ARG}"

# Run the make command directly
make "keebio/iris/rev4:varun$FLASH_ARG" || {
  echo ""
  echo "Build failed!"
...
echo "Firmware: $QMK_DIR/.build/keebio_iris_rev4_varun.hex"
echo ""
